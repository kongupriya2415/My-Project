        ...
        <Collapse isOpen={isOpen} navbar>
          <Nav className="mr-auto" navbar style={{"fontWeight":"100","color":"black"}}>
            <NavItem style={{"marginLeft":"400px"}}>
              <NavLink href="/cart" style={{"fontWeight":"700","color":"black"}}>BAG</NavLink>
            </NavItem>
            <div style={{"fontWeight":"900","color":"black","marginTop":"4px"}}>- - - - - - - - </div>
            <NavItem>
              <NavLink href="/address" style={{"fontWeight":"700","color":"#14cda8","borderBottom":"3px solid #14cda8"}}>ADDRESS</NavLink>
            </NavItem>
            <div style={{"fontWeight":"900","color":"black","marginTop":"4px"}}>- - - - - - - - </div>
            <NavItem>
