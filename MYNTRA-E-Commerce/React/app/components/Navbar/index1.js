...
//     useEffect(() => 
//     {
//         fetch(`http://localhost:5000/register/profile`,{
//           method: 'GET',
//           headers: {
...
// }
  ...
  else if(email!='' || email!=undefined && name!='' || name!=undefined)
  {
    message1="Hello"+" "+name;
    message2=email
  }
  ...
  return (
    ...
    <div>
      <Navbar expand="md" className="navbar">
        ...
        <input type="text" class="form-control" placeholder="Search the product, Brand and More" name="search" id="search" />
      </div>
            </NavItem>
